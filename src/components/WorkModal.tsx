          ...
          {!isSubmitted ? (
            <div>
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="font-sans-montserrat text-2xl font-medium tracking-tight text-white mb-1">
                  Start a Project
                </h3>
              ...
              <div className="relative flex py-2 items-center mb-6">
                ...
                <span className="flex-shrink mx-4 text-xs text-zinc-500 uppercase tracking-widest font-mono">
                  or fill brief
                </span>
                <div className="flex-grow border-t border-white/10"></div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-left">
                <div>
                  <label className="block text-xs text-zinc-400 mb-1 font-mono uppercase tracking-wider">
                    Your Name / الاسم
                  </label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#1c1d24] border border-white/10 rounded-xl px-3 py-2.5 text-sm text-white focus:outline-none focus:border-white/30 transition-colors"
                    >
                      <option value="logo-design">Logo Design</option>
                      <option value="brand-identity">Brand Identity</option>
                      <option value="other">Other Design Services</option>
                    </select>
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your design goals, timeline, and deliverables..."
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-white/30 transition-colors resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full bg-white text-black hover:bg-zinc-100 font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer font-sans-montserrat text-sm mt-2"
                >
                  <Send className="w-4 h-4 text-black" />
                  <span>Send Request to Ahmed</span>
                </button>
              </form>
            </div>
          ) : (
            ...
            <div className="text-center py-8">
              ...
              <h4 className="font-sans-montserrat text-2xl font-medium text-white mb-2">
                Request Sent!
              </h4>
